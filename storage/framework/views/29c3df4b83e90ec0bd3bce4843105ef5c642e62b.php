        ...
        <div class="header-content">
            ...
            <div class="header-right">
                <div class="stats-summary">
                    <div class="stat-item">
                        <span class="stat-number"><?php echo e($users->count()); ?></span>
                        <span class="stat-label">Utilisateurs</span>
                    </div>
                    <div class="stat-item">
                        <span class="stat-number"><?php echo e($users->where('is_admin', true)->count()); ?></span>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="filters-section mb-4" data-aos="fade-up">
        <div class="filters-container">
            ...
            <div class="export-buttons">
                <a href="<?php echo e(route('admin.users.export.pdf')); ?>" class="export-btn pdf-btn">
                    <i class="fas fa-file-pdf me-2"></i>PDF
                </a>
                <a href="<?php echo e(route('admin.users.export.excel')); ?>" class="export-btn excel-btn">
    ...
    <div class="users-grid" data-aos="fade-up">
        <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="user-card" data-user-type="<?php echo e($user->is_admin ? 'admin' : 'user'); ?>" data-user-name="<?php echo e(strtolower($user->name)); ?>" data-user-email="<?php echo e(strtolower($user->email)); ?>">
                <div class="user-header">
                    <div class="user-avatar">
                        <img src="<?php echo e(asset('images/avatar.png')); ?>" alt="<?php echo e($user->name); ?>" class="avatar-img">
                    ...
                    <div class="user-status">
                        <span class="status-dot <?php echo e($user->is_admin ? 'admin' : 'user'); ?>"></span>
                        <span class="status-text"><?php echo e($user->is_admin ? 'Administrateur' : 'Utilisateur'); ?></span>
                    </div>
                </div>
                ...
                <div class="user-actions">
                    <a href="<?php echo e(route('admin.users.edit', $user)); ?>" class="action-btn edit-btn">
                        <i class="fas fa-edit me-2"></i>Modifier
                    </a>
                    <button class="action-btn delete-btn" onclick="confirmDelete(event, '<?php echo e($user->name); ?>', '<?php echo e(route('admin.users.destroy', $user)); ?>', <?php echo e($user->id); ?>, <?php echo e(auth()->id()); ?>)">
