        ...
        <div class="header-content">
            ...
            <div class="header-right">
                <div class="export-buttons">
                    <a href="<?php echo e(route('admin.analytics.export.pdf')); ?>" class="export-btn pdf-btn" title="Télécharger le rapport PDF">
                        <i class="fas fa-file-pdf me-2"></i>PDF
                    </a>
                    <a href="<?php echo e(route('admin.analytics.export.excel')); ?>" class="export-btn excel-btn" title="Télécharger le rapport Excel">
    ...
    <div class="metrics-grid mb-5">
        <div class="metric-card" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="metric-content">
                <h3 class="metric-value"><?php echo e(number_format($stats['total_revenue'], 0, ',', ' ')); ?> FCFA</h3>
        ...
        <div class="metric-card" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="metric-content">
                <h3 class="metric-value"><?php echo e($stats['total_orders']); ?></h3>
        ...
        <div class="metric-card" data-aos="fade-up" data-aos-delay="300">
            ...
            <div class="metric-content">
                <h3 class="metric-value"><?php echo e($stats['total_users']); ?></h3>
        ...
        <div class="metric-card" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="metric-content">
                <h3 class="metric-value"><?php echo e($stats['conversion_rate']); ?>%</h3>
    ...
    <div class="advanced-metrics-grid mb-5">
        <div class="advanced-metric-card" data-aos="fade-up">
            ...
            <div class="metric-body">
                <h3 class="metric-value"><?php echo e(number_format($advancedMetrics['customer_lifetime_value'], 0, ',', ' ')); ?> FCFA</h3>
        ...
        <div class="advanced-metric-card" data-aos="fade-up">
            ...
            <div class="metric-body">
                <h3 class="metric-value"><?php echo e($advancedMetrics['repeat_customer_rate']); ?>%</h3>
        ...
        <div class="advanced-metric-card" data-aos="fade-up">
            ...
            <div class="metric-body">
                <h3 class="metric-value"><?php echo e($advancedMetrics['average_time_to_purchase']); ?> min</h3>
        ...
        <div class="advanced-metric-card" data-aos="fade-up">
            ...
            <div class="metric-body">
                <div class="geo-distribution">
                    <?php $__currentLoopData = $advancedMetrics['geographic_distribution']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $geo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="geo-item">
                            <span class="geo-region"><?php echo e($geo['region']); ?></span>
                            <span class="geo-orders"><?php echo e($geo['orders']); ?> commandes</span>
                        </div>
    ...
    <div class="insights-grid mb-5">
        <div class="insight-card" data-aos="fade-up">
            <div class="card-header">
                ...
                <a href="<?php echo e(route('admin.products.index')); ?>" class="view-all">Voir tout</a>
            </div>
            <div class="products-list">
                <?php $__empty_1 = true; $__currentLoopData = $chartData['top_products']->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="product-item">
                        ...
                        <div class="product-info">
                            ...
                            <span class="product-category"><?php echo e($product->category->name ?? 'Sans catégorie'); ?></span>
                        </div>
                        <div class="product-stats">
                            <span class="product-sales"><?php echo e($product->total_sold ?? 0); ?> vendus</span>
                            <span class="product-revenue"><?php echo e(number_format($product->revenue ?? 0, 0, ',', ' ')); ?> FCFA</span>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const advancedMetrics = <?php echo json_encode($advancedMetrics, 15, 512) ?>;
    ...
    const orderStatusData = <?php echo json_encode($chartData['order_status_distribution'], 15, 512) ?>;
    ...
    const categoryData = <?php echo json_encode($chartData['category_performance'], 15, 512) ?>;
    ...
    const hoursData = <?php echo json_encode($advancedMetrics['top_performing_hours'], 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\EazyStore\resources\views/admin/analytics/dashboard.blade.php ENDPATH**/ ?>