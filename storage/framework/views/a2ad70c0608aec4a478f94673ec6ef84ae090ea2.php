            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <ul>
                        ...
                        <li><strong>Téléphone :</strong> +221 78 920 13 38</li>
                        <li><strong>Adresse :</strong> EazyStore, Rue de Almadies, Dakar, Sénégal</li>
                    </ul>
                    
                    <div class="alert alert-info mt-4">
                        <strong>Dernière mise à jour :</strong> <?php echo e(date('d/m/Y')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\EazyStore\resources\views/politique-confidentialite.blade.php ENDPATH**/ ?>