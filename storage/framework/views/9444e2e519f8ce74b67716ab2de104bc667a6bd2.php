...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(count($cart) > 0): ?>
            ...
            <div class="col-lg-8" data-aos="fade-up">
                <div class="info-card">
                    <h4 class="fw-bold mb-4">
                        <i class="fas fa-box me-2"></i>Produits dans votre panier (<?php echo e(count($cart)); ?>)
                    </h4>
                    ...
                    <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productId => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $total += $item['price'] * $item['quantity']; ?>
                            <div class="cart-item mb-4 p-3 border rounded" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <small class="text-muted"><?php echo e($item['category'] ?? 'Sans catégorie'); ?></small>
                                    </div>
                                    <div class="col-md-2">
                                        <span class="text-success fw-bold"><?php echo e(number_format($item['price'], 0, ',', ' ')); ?> FCFA</span>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="input-group input-group-sm">
                                            <button class="btn btn-outline-secondary" type="button" onclick="updateQuantity(<?php echo e($productId); ?>, -1)">
                                    ...
                                    <div class="col-md-1">
                                        <span class="fw-bold text-primary"><?php echo e(number_format($item['price'] * $item['quantity'], 0, ',', ' ')); ?> FCFA</span>
                                    </div>
                                    <div class="col-md-1">
                                        <button class="btn btn-outline-danger btn-sm" onclick="removeItem(<?php echo e($productId); ?>)">
            ...
            <div class="col-lg-4" data-aos="fade-left">
                <div class="info-card sticky-top" style="top: 20px;">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(route('checkout')); ?>" class="btn btn-primary btn-modern">
                                <i class="fas fa-credit-card me-2"></i>Passer commande
                            </a>
                        <?php endif; ?>
                        
                        <form action="<?php echo e(route('cart.clear')); ?>" method="POST" class="d-grid">
                            <?php echo csrf_field(); ?>
                        ...
                        <a href="<?php echo e(route('products.index')); ?>" class="btn btn-outline-primary btn-modern">
        ...
        <div class="mt-5" data-aos="fade-up">
            ...
            <div class="row g-4">
                <?php $__currentLoopData = \App\Models\Product::inRandomOrder()->take(4)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-3">
                        <div class="card-modern h-100">
                            <img src="<?php echo e(asset('images/products/' . ($product->image ?? 'default.jpg'))); ?>" 
                                 class="card-img-top" 
                                 alt="<?php echo e($product->name); ?>"
                                 style="height: 150px; object-fit: cover;">
                            <div class="card-body">
                                <h6 class="fw-bold"><?php echo e($product->name); ?></h6>
                                <p class="text-success fw-bold"><?php echo e(number_format($product->price, 0, ',', ' ')); ?> FCFA</p>
                                <div class="d-grid gap-2">
        ...
        <div class="text-center py-5" data-aos="fade-up">
            <div class="empty-cart-container">
                ...
                <div class="empty-cart-actions">
                    <a href="<?php echo e(route('products.index')); ?>" class="btn btn-primary btn-modern empty-cart-button">
                        <i class="fas fa-shopping-bag me-2"></i>Voir le catalogue
                    </a>
                    <a href="<?php echo e(route('home')); ?>" class="btn btn-outline-primary btn-modern empty-cart-button-outline">
