    ...
    <div class="dashboard-header" data-aos="fade-up">
        <div class="header-content">
            <div class="header-left">
                ...
                <p class="dashboard-subtitle">Bienvenue, <?php echo e(auth()->user()->name); ?> ! Gérez votre boutique en ligne</p>
            </div>
            <div class="header-right">
                <div class="quick-stats">
                    <div class="stat-item">
                        <span class="stat-label">Aujourd'hui</span>
                        <span class="stat-value"><?php echo e(number_format($stats['revenue'], 0, ',', ' ')); ?> FCFA</span>
                    </div>
                    <div class="stat-item">
                        <span class="stat-label">Utilisateur connecté</span>
                        <span class="stat-value"><?php echo e(auth()->user()->name); ?></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="stats-grid mb-5">
        <div class="stat-card" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="stat-content">
                <h3 class="stat-number"><?php echo e($stats['products']); ?></h3>
        ...
        <div class="stat-card" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="stat-content">
                <h3 class="stat-number"><?php echo e($stats['categories']); ?></h3>
        ...
        <div class="stat-card" data-aos="fade-up" data-aos-delay="300">
            ...
            <div class="stat-content">
                <h3 class="stat-number"><?php echo e($stats['orders']); ?></h3>
                <p class="stat-label">Commandes</p>
                <div class="stat-trend <?php echo e($stats['orders'] > 0 ? 'positive' : 'neutral'); ?>">
                    <i class="fas fa-<?php echo e($stats['orders'] > 0 ? 'arrow-up' : 'minus'); ?>"></i>
                    <span><?php echo e($stats['orders'] > 0 ? '+12% ce mois' : 'Aucune commande'); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="stat-card" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="stat-content">
                <h3 class="stat-number"><?php echo e($stats['users']); ?></h3>
    ...
    <div class="performance-grid mb-5">
        <div class="performance-card revenue-card" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="card-content">
                <h2 class="revenue-amount"><?php echo e(number_format($stats['revenue'], 0, ',', ' ')); ?> FCFA</h2>
            ...
            <div class="card-content">
                <div class="payment-stats">
                    <div class="payment-item paid">
                        <span class="payment-count"><?php echo e($stats['paid_orders']); ?></span>
                        <span class="payment-label">Payées</span>
                    </div>
                    <div class="payment-item pending">
                        <span class="payment-count"><?php echo e($stats['unpaid_orders']); ?></span>
        ...
        <div class="performance-card delivery-card" data-aos="fade-up" data-aos-delay="300">
            ...
            <div class="card-content">
                <h2 class="delivery-count"><?php echo e($stats['orders'] - $stats['paid_orders']); ?></h2>
        ...
        <div class="actions-grid">
            <div class="action-card" data-aos="zoom-in" data-aos-delay="100">
                ...
                <div class="action-content">
                    ...
                    <a href="<?php echo e(route('admin.products.index')); ?>" class="action-btn">
            ...
            <div class="action-card" data-aos="zoom-in" data-aos-delay="200">
                ...
                <div class="action-content">
                    ...
                    <a href="<?php echo e(route('admin.categories.index')); ?>" class="action-btn">
                        <i class="fas fa-arrow-right me-2"></i>Accéder
                    </a>
                </div>
            </div>
            ...
            <div class="action-card" data-aos="zoom-in" data-aos-delay="300">
                ...
                <div class="action-content">
                    ...
                    <a href="<?php echo e(route('admin.orders.index')); ?>" class="action-btn">
                        <i class="fas fa-arrow-right me-2"></i>Accéder
                    </a>
                </div>
            </div>
        ...
        <div class="activities-grid">
            <div class="activity-card" data-aos="fade-up">
                <div class="card-header">
                    ...
                    <a href="<?php echo e(route('admin.orders.index')); ?>" class="view-all">Voir tout</a>
                </div>
                <div class="activity-list">
                    <?php $__empty_1 = true; $__currentLoopData = \App\Models\Order::latest()->take(5)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="activity-item">
                            <div class="activity-icon">
                                <i class="fas fa-shopping-bag"></i>
                            </div>
                            <div class="activity-content">
                                <h6 class="activity-title">Commande #<?php echo e($order->id); ?></h6>
                                <p class="activity-time"><?php echo e($order->created_at->diffForHumans()); ?></p>
                            </div>
                            <div class="activity-status">
                                <span class="status-badge status-<?php echo e($order->status === 'en attente' ? 'pending' : ($order->status === 'confirmé' ? 'confirmed' : 'processing')); ?>">
                                    <?php echo e(ucfirst($order->status)); ?>

                                </span>
                                <span class="activity-amount"><?php echo e(number_format($order->total, 0, ',', ' ')); ?> FCFA</span>
                            </div>
                        </div>
            ...
            <div class="activity-card" data-aos="fade-up">
                <div class="card-header">
                    ...
                    <a href="<?php echo e(route('admin.users.index')); ?>" class="view-all">Voir tout</a>
                </div>
                <div class="activity-list">
                    <?php $__empty_1 = true; $__currentLoopData = \App\Models\User::latest()->take(5)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="activity-item">
                            ...
                            <div class="activity-content">
                                <h6 class="activity-title"><?php echo e($user->name); ?></h6>
                                <p class="activity-email"><?php echo e($user->email); ?></p>
                            </div>
                            <div class="activity-time">
                                <span class="time-ago"><?php echo e($user->created_at->diffForHumans()); ?></span>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="empty-state">
