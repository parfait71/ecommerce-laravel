...
<body>
    ...
    <div class="content">
        <h2>Bonjour <?php echo e($order->user->name); ?>,</h2>
        
        <p>Votre facture pour la commande n°<?php echo e($order->id); ?> est maintenant disponible.</p>
        ...
        <ul>
            ...
            <li>Email : contact@eazystore.com</li>
        </ul>
...
</html> <?php /**PATH C:\Users\User\Desktop\EazyStore\resources\views/emails/invoice-email.blade.php ENDPATH**/ ?>