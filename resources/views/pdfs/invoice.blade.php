...
<body>
    ...
    <div class="client-section">
        ...
        @if($order->payment)
            <p><strong>Mode de paiement:</strong> {{ $order->payment->payment_method ?: 'Non renseigné' }}</p>
            <p><strong>Statut du paiement:</strong> {{ strtolower($order->payment->status) === 'payé' ? 'Payé' : 'Non payé' }}</p>
        @else
