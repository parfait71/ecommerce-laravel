...
<head>
    ...
    <title>@yield('title', 'EazyStore - Votre boutique en ligne')</title>
        ...
        <footer class="footer-custom">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <ul class="list-unstyled">
                            <li><a href="{{ route('products.index') }}" class="text-white-50">Catalogue</a></li>
                ...
                <div class="text-center">
                    <p>&copy; {{ date('Y') }} EazyStore. Tous droits réservés.</p>
                </div>
            </div>
        </footer>
    </div>
